...
class AbsenceTableViewController: UITableViewController {
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        let cell = tableView.dequeueReusableCell(withIdentifier: "attendenceCell", for: indexPath)
        
        // Configure the cell...
        
        if let attendenceCell = cell as? AbsenceTableViewCell {
            if let therealdata = data {
                let absence = therealdata[indexPath.row]
                
                attendenceCell.dateLabel?.text = absence.date
